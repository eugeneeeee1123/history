...
const I18N = {
  zh: {
    ...
    'hero.desc':'从尼罗河到长安城，从马六甲海峡到安第斯雨林，这是一部收录 174 位真实与传说人物的编年史档案，按大陆、文明与身份重新编目。',
    ...
    'search.hint':'按名称搜索 4 大区域 · 73 个时代 · 174 位人物',
    ...
    'gallery.note':'全部 174 位人物一览，可按大洲与身份筛选。',
  ...
  en: {
    ...
    'hero.desc':'From the Nile to Chang\'an, from the Strait of Malacca to the Andean jungle, an archive of 174 historical and legendary figures, catalogued by continent, civilization and role.',
    ...
    'search.hint':'Search across 4 regions · 73 eras · 174 figures',
    ...
    'gallery.note':'All 174 figures at a glance - filter by continent or role.',
